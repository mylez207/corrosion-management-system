...
def send_email_notification(to_email, severity):
    ...
    subject = f"Corrosion Alert: {severity} Severity Detected"
    if severity == "Severe":
        body = "Immediate maintenance is required due to severe corrosion."
    else:
        body = "High corrosion detected. Please schedule maintenance as soon as possible."

    # For demo purposes, we'll just simulate email sending
    # In production, configure with real SMTP settings
    try:
        # Simulated email sending - always returns success for demo
